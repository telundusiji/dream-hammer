...
public class TestFixedWindowRollingPolicy extends RollingPolicyBase {
    ...
    TestFileNamePattern fileNamePattern;
    ...
    public TestFixedWindowRollingPolicy() {
        minIndex = 1;
        maxIndex = 7;
    }
    ...
    public void start() {
        ...
        if (fileNamePatternStr != null) {
            fileNamePattern = new TestFileNamePattern(fileNamePatternStr, this.context);
